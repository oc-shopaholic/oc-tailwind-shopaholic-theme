...
<table>
    ...
    <tr>
        ...
        <td>I can browse “Catalog”.
            <ol>     
                <li>I can see Product Cards. Any Product Card has:</li>
                    <ol>
                      <li>image;</li>
                      <li>old price;</li>
                      <li>new price;</li>
                      <li>name;</li>
                      <li>lable;</li>
                      <li>"ADD TO SHOPPING CART" button.</li>
                    </ol>
    ...
    <tr>
        ...
        <ol>
            ...
            <li>I can perform <a href="ТУТ БУДЕТ ССЫЛКА"> US-05: Add a Product Item to the "Wish List". </a> </li>  <!-- TODO: add link --> 
            <li>I can perform <a href="ТУТ БУДЕТ ССЫЛКА"> US-06: Delete a Product Item from the "Wish List". </a> </li>  <!-- TODO: add link --> 
        </ol>
        </td>
    </tr>
</table>
...
<table>
    ...
    <tr>
    <td>2a</td>
    <td><li>I can perform <a href="ТУТ БУДЕТ ССЫЛКА"> US-04: Find Product Item(s). </a> </li>  <!-- TODO: add link --> </td>
    </tr>
        <tr>
        <td>3a</td>
